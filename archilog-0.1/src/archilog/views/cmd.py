...
# Commandes CLI
cmd = Blueprint("cmd", __name__, url_prefix="/cmd", cli_group="archilog")

# Routes API - facultatif, mais cela montre comment séparer les fonctionnalités
@cmd.route('/entries', methods=['GET'])
def get_entries():
